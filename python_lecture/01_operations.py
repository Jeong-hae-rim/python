...
print(not True)
print(not 0) 
#boolean형으로 출력 됐을 때 0은 default가 false이기 때문에
...
#False? 안에 a는 있고 b는 없다. and니까 b는 없으니 False가 맞는 것 같은데...
print(('b' and 'a') in vowels) 
#True? 왜지? 마지막까지 판단한 a가 vowels에 있기 때문에 true로 출력함
print('a' and 'b') 
#b? and라는 것은 둘 다 True여야 함. 앞이 True여도 뒤가 True인지 분간할 수 없기 때문에 뒤에까지 평가함
